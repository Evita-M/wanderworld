...
import { ExpeditionSchema } from '@/features/expedition/edit/model/validation';
import { defaultValues, expeditionSchema } from '../../model/validation';
...
export const CreateExpedition: FC<ExpeditionsFormProps> = ({
  expedition,
  isEdit = false,
  onCancel,
  onSuccess,
